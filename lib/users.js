...
module.exports = function(plugin, log, config) {
    ...
    if(Mailer) {
        ...
        TemplateEngine.registerTemplate('verify-email', fs.readFileSync(path.resolve(__dirname, "../templates", "verify-email.hbs")));
        TemplateEngine.registerTemplate('welcome-email', fs.readFileSync(path.resolve(__dirname, "../templates", "welcome-email.hbs")));
    }
    else {
